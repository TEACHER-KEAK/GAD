		...
		<div class="row">
	      	<div class="col-md-3">
				...
				<a class="fancybox" href="{{ asset('/images/about-company-logo.png')}}" data-fancybox-group="gallery" >
	      		...
	      		<h3 style="color:#666; font-size:16px;"> Company Logo</h3>
	      		</div>
